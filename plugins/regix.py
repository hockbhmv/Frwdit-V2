...
async def edit(msg, title, fetched, total_files, duplicate, deleted, skip, filtered, status, button, start, total):
   ...
   if not button:
        ...
        button =  [[
                InlineKeyboardButton(progress, f'fwrdstatus#{speed}#{estimated_total_time}#{percentages}')
                ],[
