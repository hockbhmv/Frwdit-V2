...
async def run(bot, message):
    ...
    _toid = await bot.ask(message.chat.id, Translation.TO_MSG.format(bot['username']), reply_markup=ReplyKeyboardMarkup(buttons, one_time_keyboard=True, resize_keyboard=True))
